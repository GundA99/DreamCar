...
//}
	...
	public Long findUserId(String userName) {
		Users user = usersRepository.findByEmail(userName).orElseThrow(() -> new RuntimeException("Invalid Email"));
	...
	public Users authenitcateUser(String email) {
		...
		return usersRepository.findByEmail(email).orElseThrow(() -> new RuntimeException("Invalid Email"));
	}

	@Override
	public UserAuthDTO finfUserById(int userId) {
		Users user = usersRepository.findById((long) userId).orElseThrow(() -> new RuntimeException("Invalid User Id"));
